...
from openLMS.email_backend import SMTPConfigHelper
import logging
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--fix-config", action="store_true", help="Suggest configuration fixes"
        )

    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS("=== Email Configuration Diagnostic ==="))
...
Best regards,
A&F Laundry System
""".format(settings.EMAIL_BACKEND, self._get_current_time()),
    ...
    def _suggest_config_fixes(self):
        ...
        if "gmail.com" in settings.EMAIL_HOST_USER:
            ...
            "outlook.com" in settings.EMAIL_HOST_USER
            or "hotmail.com" in settings.EMAIL_HOST_USER
        ):
            provider = "outlook"
...
EMAIL_BACKEND=openLMS.email_backend.RobustEmailBackend
