...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.system_settings.context_processors.system_settings",
            ],
        },
    },
]
...
LOYALTY_POINTS_REDEMPTION_RATE = Decimal(
    os.environ.get("LOYALTY_POINTS_REDEMPTION_RATE", "0.10")
)  # 1 point = $0.10
...
EMAIL_BACKEND = config(
    "EMAIL_BACKEND",
    default="apps.system_settings.email_backend.SystemSettingsEmailBackend",
)
...
ACCOUNT_EMAIL_VERIFICATION = (
    "optional"  # Don't require email verification if SMTP fails
)
